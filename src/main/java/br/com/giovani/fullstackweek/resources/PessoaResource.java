package br.com.giovani.fullstackweek.resources;
...
import br.com.giovani.fullstackweek.repository.PessoaRepository;
...
public class PessoaResource {
	...
	@GetMapping("/{codigo}")
	public Pessoa PessoabuscarPeloCodigo(@PathVariable Long codigo) {
